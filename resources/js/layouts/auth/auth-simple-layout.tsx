        ...
        <div className="flex min-h-screen w-full">
            ...
            <div className="relative hidden items-center justify-center overflow-hidden p-12 lg:flex lg:w-1/2">
                <div
                    ...
                    style={{
                        backgroundImage: "url('/img/novedades_hero.png')",
                    }}
                />
                ...
                <div className="relative z-20 max-w-lg text-white">
                    ...
                    <p className="mb-10 text-lg leading-relaxed opacity-90">
                        El portal a la cultura, el bienestar y la aventura en el
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        <div className="rounded-xl border border-white/20 p-6 backdrop-blur-md">
                            ...
                            <div className="text-sm tracking-tighter uppercase opacity-80">
                                Registrate gratis y aprovechá todos los
                                beneficios disponibles para usuarios
                                registrados.
                            </div>
                        </div>
                    </div>
