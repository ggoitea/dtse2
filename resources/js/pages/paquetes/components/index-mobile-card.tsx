...
const estadoStyles: Record<string, string> = {
    ...
    agotado: 'bg-orange-500/10 text-orange-600 dark:bg-orange-500/20 dark:text-orange-400',
    suspendido: 'bg-yellow-500/10 text-yellow-600 dark:bg-yellow-500/20 dark:text-yellow-400',
    cancelado: 'bg-red-500/10 text-red-600 dark:bg-red-500/20 dark:text-red-400',
};

export default function PaqueteMobileCard({ row }: { row: Row<PaqueteTuristico> }) {
            ...
            <div className="mb-3 flex items-start justify-between gap-2">
                <div className="min-w-0">
                    ...
                    <p className="text-sm text-muted-foreground">
                        {categoriaLabels[paquete.categoria] ?? paquete.categoria}
                    </p>
                </div>
                <Badge
